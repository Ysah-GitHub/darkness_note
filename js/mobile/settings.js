...
function settings_note_header(note_interface){
  ...
  icon_double_left.className = "icon rotate_270";
  ...
  icon_left.className = "icon rotate_270";
  ...
  icon_right.className = "icon rotate_90";
  ...
  icon_double_right.className = "icon rotate_90";
