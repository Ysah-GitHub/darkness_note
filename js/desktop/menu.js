function menu(){
  ...
  menu_container.id = "menu";

  menu_container.append(menu_settings());
  menu_container.append(menu_note_add());
  menu_container.append(menu_note_trash());
...
function menu_settings_back(){
  ...
  settings_back_icon.append(icon_draw("folder_back", 192, 192, "rgb(65, 65, 65)"));
...
function menu_note_add(){
  ...
  add_icon.append(icon_draw("add", 192, 192, "rgb(65, 65, 65)"));
...
function menu_note_trash(){
  ...
  trash_icon.append(icon_draw("trash", 192, 192, "rgb(65, 65, 65)"));
...
function menu_trash_back(){
  ...
  trash_back_icon.append(icon_draw("folder_back", 192, 192, "rgb(65, 65, 65)"));
