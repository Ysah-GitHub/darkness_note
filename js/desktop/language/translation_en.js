function translation(){
  return {
    ...
    note_export_json: "Export all notes",
    note_export_json_desc: "Export all notes in .json file",
    note_import_json: "Import notes",
    note_import_json_desc: "Import notes from .json file",
    note_export_txt: "Export note",
    note_export_txt_desc: "Export note in .txt file",
    note_import_txt: "Import note",
    note_import_txt_desc: "Import note from .txt file",
