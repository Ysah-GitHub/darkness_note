function translation_fr(){
  return {
    ...
    settings: {
      ...
      note_auto_clean_desc: "Suppression automatique des notes sans titre et sans texte à chaque démarrage de l'application",
      ...
      note_text_size_exemple: "Voici la taille d'un texte",
      note_title_size: "Taille des titres",
      note_title_size_exemple: "Voici la taille d'un titre",
      other: "Autre",
      reset: "Réinitialiser",
    ...
    error: {
      ...
      error_file_size_1000000: "Erreur: La taille du fichier est supérieur à 1Mo \nT-T",
      error_file_json: "Erreur: Le fichier n'est pas au format .json \n:x",
      error_file_txt: "Erreur: Le fichier n'est pas au format .txt \n:x",
      error_navigator_offline: "Erreur: Le Navigateur est Hors-Ligne \n:/"
    },
    app: {
